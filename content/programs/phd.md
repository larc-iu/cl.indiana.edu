...
**Note: These are the [most recent requirements, updated in 2025-2026](https://bulletins.iu.edu/iu/gradschool/2025-2026/programs/bloomington/linguistics/index.shtml).**
...
All requirements not listed below are the same as those for the Ph.D. in Linguistics.

## Course Requirements

A minimum of 90 credit hours, including dissertation. Specific requirements include:
...
* One graduate-level course each in phonetics, phonology, and syntax
* At least 6 additional credit hours in linguistics at the 600-700 levels
...
Knowledge of the structure of a language other than English and outside the student’s general language family, with the choice determined in consultation with the student's advisory committee. This requirement can be fulfilled in three ways:
...
The student must demonstrate proficiency (1) in the basics of discrete mathematics or mathematical linguistics, which can be met by courses such as COGS-Q 520 Mathematics and Logic for Cognitive Science or LING-L 611 Models of Linguistic Structure; and (2) in programming techniques, with working knowledge of at least two programming languages.

Completion of LING-L 555 satisfies working knowledge of one programming language. Students then need a second programming language, preferably either Java or C++. Students should consult their academic advisor about what course would be most appropriate to take.
